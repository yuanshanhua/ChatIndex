...
\copy part from './part.tbl' csv delimiter '|' ;
analyze part;
\copy supplier from './supplier.tbl' csv delimiter '|' ;
analyze supplier;
\copy partsupp from './partsupp.tbl' csv delimiter '|' ;
analyze partsupp;
\copy customer from './customer.tbl' csv delimiter '|' ;
analyze customer;
\copy orders from './orders.tbl' csv delimiter '|' ;
analyze orders;
\copy lineitem from './lineitem.tbl' csv delimiter '|' ;
analyze lineitem;
\copy nation from './nation.tbl' csv delimiter '|' ;
analyze nation;
\copy region from './region.tbl' csv delimiter '|' ;
analyze region;